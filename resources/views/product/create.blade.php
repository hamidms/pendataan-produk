...
<form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="number" name="buy_price" id="buy_price" step="0.01" required>
    </div>

    <div class="mb-3">
        <label class="form-label" for="sell_price">Harga Jual</label>
        <input class="form-control" type="number" name="sell_price" id="sell_price" step="0.01" required>
    </div>
